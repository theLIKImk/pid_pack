...
:installed-info
	if not exist "%PIDMD_SYS%PACK\%2\info.ini" goto end
...
:remove
	...
	REM echo.[%PACK_REMOVE_CHECK_DEPENDS%]
...
:del
	...
	echo Remove %PIDMD_ROOT%\%RM_PATH%
...
:install 
	...
	REM 复制信息文件
	echo Copying package file data
